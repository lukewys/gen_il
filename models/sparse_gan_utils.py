...
def save_sample(model_assets, log_dir, iteration, transform, **kwargs):
    ...
    save_image(sample.view(SAMPLE_NUM, D.image_ch, IMAGE_SIZE, IMAGE_SIZE),
               f'{log_dir}/sample_iter_{iteration}_full' + '.png', nrow=32)
    save_image(sample.view(SAMPLE_NUM, D.image_ch, IMAGE_SIZE, IMAGE_SIZE)[:64],
