...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='/data/creativity_generation/generative_IL/data')

    args = parser.parse_args()

    # log_dir = f'./logs/wta_logs/dataset_{args.dataset}_batch_size_{args.batch_size}_' \
