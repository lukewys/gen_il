...
from models.attn_feature_map_utils import get_new_model, get_data_config
...
if __name__ == '__main__':
    ...
    log_dir = f'./logs/attn_feature_map_logs/dataset_{args.dataset}_batch_size_{args.batch_size}_' \
