...
from models.attn_position_and_vector_hybrid_utils import get_new_model, get_data_config
...
if __name__ == '__main__':
    ...
    log_dir = f'./logs/position_and_vector_hybrid_logs/dataset_{args.dataset}_batch_size_{args.batch_size}_' \
