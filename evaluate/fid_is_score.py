...
# https://github.com/GiangHLe/pytorch-fid/tree/is
...
# usage (FID) (pip installed): python -m pytorch_fid path/to/dataset1 path/to/dataset2
# usage (IS) (pip installed): python -m pytorch_fid path/to/dataset1 path/to/dataset2 --inception_score
# usage (FID): python fid_is_score.py path/to/dataset1 path/to/dataset2 --inception_score
# usage (IS): python fid_is_score.py path/to/dataset1 path/to/dataset2 --inception_score --inception_score
